...
public class TicTacToeGame {
    ...
    public void positionSelected(Position positionSelected) {
        ...
        if (markAtSelectedPosition == currentPlayer.getMark()) {
            ...
            if (this.selectedPosition != null) {
                ...
                setMark(currentPlayer.getMark(), positionSelected);
                this.turnCounter++;
            }
            checkGameOver(currentPlayer, positionSelected);
        } else if (selectedPosition != null) {
            // ignore invalid destination
            setMark(currentPlayer.getMark(), selectedPosition);
    ...
    private boolean checkAdjacency(Position p1, Position p2) {
        int colDistance = Math.abs(p1.getCol() - p2.getCol());
        int rowDistance = Math.abs(p1.getRow() - p2.getRow());
    ...
    private void setMark(Mark mark, Position position) {
        board[position.getRow()][position.getCol()] = mark;
